-- Cấu hình
local min_delay = 20 -- Độ trễ tối thiểu giữa các tin nhắn (giây)
local max_delay = 50  -- Độ trễ tối đa giữa các tin nhắn (giây)
local max_messages = 2 -- Số lần spam trước khi tự dừng
